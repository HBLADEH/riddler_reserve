...
public class OrderGroupServiceImpl implements OrderGroupService {
    ...
    @Override
    public List<OrderGroupVO> listOrderGroupsByDate(Date startTime, Date endTime) {
        return orderGroupMapper.listOrderGroupsByDate(startTime, endTime);
    }

    @Override
    public List<OrderGroupPlayerView> listOrderGroupsByFront(Date playTime, String goodsName, String roomName, String roundName) {
        return orderGroupMapper.listOrderGroupsByFront(playTime, goodsName, roomName, roundName);
    }
}
